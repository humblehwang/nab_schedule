...
def crossover(s1,s2,g):
    ...
    #print("before",s1.dateSchedule[g],s2.dateSchedule[g])
    
    s1.nbaSchedule[g][0].teamCalendar[d2] = False
    s1.nbaSchedule[g][1].teamCalendar[d2] = False
    s2.nbaSchedule[g][0].teamCalendar[d1] = False
    s2.nbaSchedule[g][1].teamCalendar[d1] = False
    
    
    if s1.nbaSchedule[g][0].teamCalendar[d1] == True or s1.nbaSchedule[g][1].teamCalendar[d1] == True:
        randomDateIndex = randomFalseDate(s1.nbaSchedule[g][0].teamCalendar.values(),s1.nbaSchedule[g][1].teamCalendar.values())
        if randomDateIndex == 9999:
            d1 = d2
        else:
            d1 = s1.nbaSchedule[g][0].teamCalendar.keys()[randomDateIndex]
    ...
    s1.nbaSchedule[g][0].schedule.append(Game(d1, s1.nbaSchedule[g][1], True))
    s1.nbaSchedule[g][1].schedule.append(Game(d1, s1.nbaSchedule[g][0], False))
    
              
    if s2.nbaSchedule[g][0].teamCalendar[d2] == True or s2.nbaSchedule[g][1].teamCalendar[d2] == True:
        randomDateIndex = randomFalseDate(s2.nbaSchedule[g][0].teamCalendar.values(),s2.nbaSchedule[g][1].teamCalendar.values())
        if randomDateIndex == 9999:
            d2 = d1
        else:
            d2 = s2.nbaSchedule[g][0].teamCalendar.keys()[randomDateIndex]
              
    s2.nbaSchedule[g][0].teamCalendar[d2] = True
    s2.nbaSchedule[g][1].teamCalendar[d2] = True
    s2.dateSchedule[g] = d2
    
    s2.nbaSchedule[g][0].schedule.append(Game(d2, s2.nbaSchedule[g][1], True))
    s2.nbaSchedule[g][1].schedule.append(Game(d2, s2.nbaSchedule[g][0], False))

    #print("After",s1.dateSchedule[g],s2.dateSchedule[g])
...
for i in range(0,numChromosome):
    ...
    s = hillClimbing(s, numIters, numSwaps=1)
    nba.append(s)
...
fileName = 'GA && HC__'+'('+str(best.totalTriples())+',' + str(util.totalBackToBacks(best.teams))+',' + str(best.totalFourInFive())+')'
